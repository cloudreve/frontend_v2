    ...
    render() {
        ...
        return (
            <div className={classes.container}>
                ...
                >
                {(!this.state.error&&this.props.file.pic!==""&& this.props.file.pic!==" "&&allowSharePreview())&&
            ...
            {(this.state.error || this.props.file.pic===""|| this.props.file.pic===" "||!allowSharePreview())&& <Divider/> }
